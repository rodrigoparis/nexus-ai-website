...
export function Footer() {
  return (
    <footer className="bg-nexus-surface border-t border-nexus-text-secondary/20">
      <Container>
        <div className="py-12 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-nexus-text-secondary text-sm leading-relaxed mb-6">
            ...
            {/* Services */}
            <div>
              <h3 className="font-semibold text-nexus-text-primary mb-4">Servicios</h3>
              <ul className="space-y-3">
                {navigation.servicios.map((item) => (
                  <li key={item.name}>
                    <Link
                      href={item.href}
                      className="text-nexus-text-secondary hover:text-nexus-text-primary transition-colors duration-200 text-sm"
                    >
                      {item.name}
                    </Link>
                  </li>
            ...
            {/* Company */}
            <div>
              <h3 className="font-semibold text-nexus-text-primary mb-4">Empresa</h3>
              <ul className="space-y-3">
            ...
            {/* Legal & Social */}
            <div>
              <h3 className="font-semibold text-nexus-text-primary mb-4">Legal</h3>
              ...
              <h3 className="font-semibold text-nexus-text-primary mb-4">Síguenos</h3>
              <ul className="space-y-3">
          ...
          <div className="mt-12 pt-8 border-t border-nexus-text-secondary/20">
